...
public class Day03NoMatterHowYouSliceIt implements DailyProblem<Integer, Integer> {
    ...
    public Day03NoMatterHowYouSliceIt(String filename) {
        List<Pair<Integer, Rectangle>> input = FileUtilities.readLines(filename, Day03NoMatterHowYouSliceIt::PARSER);
